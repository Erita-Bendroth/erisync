  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Partnership Capacity Configuration</DialogTitle>
          <DialogDescription>
            Set minimum and maximum staffing requirements across all teams in <strong>{partnershipName}</strong>
          </DialogDescription>
        </DialogHeader>
