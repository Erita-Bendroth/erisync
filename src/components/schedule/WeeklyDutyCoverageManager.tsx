...
export function WeeklyDutyCoverageManager({ open, onOpenChange }: WeeklyDutyCoverageManagerProps) {
  ...
  const loadAutoGeneratedData = async () => {
    ...
    if (error || !data?.assignments) {
      ...
      toast({ title: "Success", description: "Loaded current assignments into editor" });
    }
  };
        ...
        <Tabs defaultValue="template">
          ...
          <TabsContent value="customize" className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Customize the email layout by loading current assignments and editing the table.
                Changes won't affect the database - they're only for this email.
              </AlertDescription>
            </Alert>

            <div className="flex gap-2">
              <Button onClick={loadAutoGeneratedData} disabled={loading || !selectedTemplate}>
