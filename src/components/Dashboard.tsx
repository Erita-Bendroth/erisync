  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats?.todayScheduleCount || 0}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats?.availableNowCount || 0}</div>
          <p className="text-xs text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats?.pendingActionsCount || 0}</div>
          <p className="text-xs text-muted-foreground">
