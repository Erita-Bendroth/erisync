-- Drop the conflicting unique constraint that doesn't include team_id
DROP INDEX IF EXISTS schedule_entries_user_id_date_key;

-- Update the bulk schedule generation function to use the correct constraint name
    ...
    WHILE current_date_var <= _end_date LOOP
        ...
        IF day_of_week BETWEEN 1 AND 5 THEN
            ...
            IF NOT EXISTS (
                ...
                -- Use INSERT ... ON CONFLICT with the correct constraint name
