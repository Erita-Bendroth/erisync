-- Update get_multiple_basic_profile_info to include country_code and region_code
-- Required for country-specific shift time assignments in schedule wizard

-- Drop the old function first
DROP FUNCTION IF EXISTS public.get_multiple_basic_profile_info(uuid[]);

-- Recreate with additional country_code and region_code columns
