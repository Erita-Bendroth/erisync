-- Fix the holiday check logic in create_default_schedule_with_holidays function
...
BEGIN
    ...
    WHILE current_date_var <= _end_date LOOP
        ...
        IF day_of_week BETWEEN 1 AND 5 THEN
            ...
            -- Fixed: Check for public holidays (user_id IS NULL) OR personal holidays (user_id = _user_id)
            IF NOT EXISTS (
