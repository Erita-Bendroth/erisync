-- Update the shift counts function to include 'late' shifts as night shifts
...
BEGIN
  ...
  SELECT 
    ...
    -- Count night shifts (including both 'night' and 'late' shift types)
    COUNT(*) FILTER (
      WHERE se.shift_type IN ('night', 'late')
      AND se.activity_type = 'work'
