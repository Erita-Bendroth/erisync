-- Create a security definer function to revoke/cancel delegations
-- This handles removing temporary team access and updating delegation status
...
BEGIN
  ...
  -- Get the teams that were granted during delegation
  SELECT details->'teams_granted' INTO _granted_teams
...
COMMENT ON FUNCTION public.revoke_manager_delegation IS 'Revokes a manager delegation and removes temporary team access. Bypasses RLS for team member deletion.';